...
import { Vector2, Mesh, Vector3, Line } from "three";
...
export class TrackGeneratorService {
    ...
    private updatePath(): void {
        const newLine: Line = this._renderer.generatePath(this._points.map((p) => p.getWorldPosition()));
        this._renderer.replaceLine(this._path, newLine);
        this._path = newLine;
    }
