...
export const PLAYER_NAMES: Map<LoadedObject, string> = new Map<LoadedObject, string>([[LoadedObject.carBlue, "Blue"],
                                                                                      [LoadedObject.carGreen, "Green"],
                                                                                      [LoadedObject.carOrange, "Orange"],
                                                                                      [LoadedObject.carPink, "Pink"],
                                                                                      [LoadedObject.carPurple, "Purple"],
                                                                                      [LoadedObject.carRed, "Red"],
                                                                                      [LoadedObject.carYellow, "Yellow"]]);
